// ============================================================
// LoginPage.jsx — Layout visual da tela de login
// Empresa: Fast Ariam Londrina
//
// ✅ O QUE ESTÁ FEITO (layout):
//   - Tela completa com fundo azul degradê
//   - Logo, título e subtítulo
//   - Card de login com campos CPF e Senha
...
//
// 🔧 O QUE FALTA INTEGRAR (backend/dev):
//   - Conectar função handleLogin() à API real
//   - Configurar redirecionamento após login (react-router-dom)
//   - Configurar redirecionamento do link de cadastro
//   - Validação real de CPF (opcional)
//   - Gerenciamento de token/sessão (JWT, context, etc.)
// ============================================================
...
export default function LoginPage() {
  ...
  // -------------------------------------------------------
  // 🔧 INTEGRAR: substitua o corpo desta função pela chamada
  //    real à sua API de autenticação.
  //    Recebe: cpf (string formatada), senha (string)
  //    Deve fazer: POST /api/login → redirecionar ou setErro()
  // -------------------------------------------------------
  async function handleLogin(e) {
    e.preventDefault();
    setErro("");

    // Validações de campo vazio (pode manter)
    if (!cpf || !senha) {
    ...
    // TODO: substitua este bloco pela sua chamada de API
    // Exemplo:
    // try {
    ...
    //   } else {
    //     setErro(data.message || "CPF ou senha incorretos.");
    //   }
    // } catch {
    //   setErro("Erro de conexão. Tente novamente.");
    // }

    // Simulação visual apenas — REMOVER em produção
